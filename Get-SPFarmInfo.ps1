...
function CheckTimerJobHistory()
{
    ...
    Write-Host " ---- https://urldefense.com/v3/__https://blogs.technet.microsoft.com/stefan_gossner/2018/04/12/changes-in-the-timerjobhistory-table-maintenance-introduced-in-april-2018-cu-for-sharepoint-2013/__;!!DNJQ_wj6RNmOacf0Wt8!JZm8oBAsOtX3IgyNWN-p3OfPucqQ0ku9LOkZH2gPB3Te3aayVgr1GUSiNbuzNoRYOxrTpnlD4yOEUaD56l-dcrVE6Upz7Q$ "
    Write-Host ""
              ...
              foreach ($altUrl in Get-SPAlternateUrl) {
                if ($startUri.AbsoluteUri.toString() -ieq $altUrl.Uri.toString()) 
                {
                  ...
                  if ($altUrl.UrlZone -ieq "Default") 
                  {
                    ...
                    "  ----- Check out https://urldefense.com/v3/__https://www.ajcns.com/2021/02/problems-crawling-the-non-defaul-zone-for-a-sharepoint-web-application/__;!!DNJQ_wj6RNmOacf0Wt8!JZm8oBAsOtX3IgyNWN-p3OfPucqQ0ku9LOkZH2gPB3Te3aayVgr1GUSiNbuzNoRYOxrTpnlD4yOEUaD56l-dcrV7ekSwYA$  " 
                  }
                }
              }
